...
import {addFeature, removeFeature, increasePrice} from './actions'
  ...
  return (
    <div className="boxes">
      <div className="box">
        ...
        <AddedFeatures car={props.displayedCar} removeFeature={removeFeature} />
      </div>
      <div className="box">
...
export default connect(
  mapStateToProps,
  {addFeature, removeFeature, increasePrice}
)(App);
